    ...
    <div className="flex justify-around flex-col items-center p-3">
      ...
      <div className="text-white font-pop">
        ...
        <div className="mt-5 flex justify-center items-center flex-col text-[18px]">
          <h2>
            <span className=" text-white/70"> TECHNOLOGY</span> = Data Analytics
          </h2>
          <h2>
      ...
      <div className="mt-5 text-white font-pop">
        ...
        <ul className=" list-inside list-disc flex flex-col gap-2 ">
          ...
          <li>
            ...
            science, patient length of stay is one critical parameter to observe
            and predict if one wants to improve the efficiency of the healthcare
            management in a hospital.
          </li>
          <li>
            This parameter helps hospitals to identify patients of high LOS-risk
            (patients who will stay longer) at the time of admission.
          </li>
          <li>
          ...
          <li>
            ...
            Scientist of Health Man – a not for profit organization dedicated to
            manage the functioning of Hospitals in a professional and optimal
            manner.
          </li>
        </ul>
      </div>
      ...
      <div className="mt-5 text-white font-pop">
        ...
        <p>
          The goal is to accurately predict the Length of Stay for each patient
          on case by case basis so that the Hospitals can use this information
          for optimal resource allocation and better functioning. The length of
          stay is divided into 11 different classes ranging from 0-10 days to
          more than 100 days.
        </p>
      </div>
